...
@pytest.fixture
def mock_adapter() -> ExecutionBackend:
    """Mock execution backend returning canned NormalizedProviderResult."""
...
async def executor(
    ...
    return WorkflowExecutor(
        ...
        execution_backend=mock_adapter,
    )
